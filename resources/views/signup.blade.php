@include('common.header', ['title' => 'Register'])
...
<div class="container center-form ">
    <div style="width: 100%" class="mb-3 p-4 shadow">
        <form action="{{ route('register') }}" method="POST">
            @csrf
            <h1 class="mainheading" style="color:var( --pink-color)">Create An Account</h1>
            <div class="row mt-4">
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class=" @error('firstname') is-invalid @enderror"
                    ...
                    <div class="form-group">
                        ...
                        <div style="display: flex; align-items: center;">
                            <div id="flag-container" style="flex: 0 0 auto;"></div>
...
<select  id="country" name="country" value="{{ old('country') }}" class="   @error('country') is-invalid @enderror">
    ...
    <option value="Zimbabwe">Zimbabwe</option>
                    ...
                    <div class="form-group">
                        ...
                        <select class=" @error('currency') is-invalid @enderror" name="currency">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="   @error('zipcode') is-invalid @enderror"
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="address" class="   @error('address') is-invalid @enderror" cols="30" rows="8">{{ old('address') }}</textarea>
